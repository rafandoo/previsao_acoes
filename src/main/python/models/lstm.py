...
class mLSTM(InterfaceModels):
    """
    Classe que implementa o modelo LSTM.

    Attributes:
        _id (str): Identificador do modelo.
        _ticker (str): Ticker do ativo.
        _time (float): Tempo de execução do modelo.
    ...
    def __init__(
        ...
        self._id = id
        self._ticker = ticker
        self._model = Sequential(name='LSTM')
        ...
        if (len(activation_functions) != ModelEnum.LSTM_ACTIVATION_FUNCTIONS_SIZE.value):
